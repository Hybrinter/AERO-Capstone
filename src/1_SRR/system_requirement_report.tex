...
\begin{titlepage}
    ...
    {\large \textbf{Revision:} Final v1.1\par}
...
\begin{table}[!htbp]
    ...
    Noah Matus & \S3, \S4 & \S1, \S2, \S4 & 1316 & 0 \\
...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}>{\centering\arraybackslash}m{1.9cm}
                                    >{\raggedright\arraybackslash}m{6.1cm}
    ...
    $\geq$1 flight experiment is sent aboard the TAMU-SPIRIT facility. \\ \hline
    ...
    $\geq$ 1 primary research objective successfully achieved. \\ \hline
    ...
    All experiments receive the required power and data throughout the mission. \\ \hline
    ...
    All flight experiments operate for the full mission duration with no anomalies, and all samples are returned to Earth. \\ \hline
...
Inspection of carrier slot count in TAMU-SPIRIT flight hardware. \\ \hline
...
Inspection of interface drawings and hardware configuration. \\ \hline
...
Interface inspection and functional test of power/data connections. \\ \hline
...
End-to-end communication demonstration with Payload Operations Control Center (POCC). \\ \hline
...
All integrated SC and PC Payloads shall pass thermal cycling consistent with ISS operational conditions. &
 &
Thermal cycling test report. \\ \hline
...
All integrated SC and PC payloads shall obtain NASA safety approval prior to launch. &
 &
Documentation review and certification record. \\ \hline
...
Analysis of power, thermal, and operational lifetime. \\ \hline
...
Interface compatibility documentation review. \\ \hline
...
Demonstration and interface compliance review. \\ \hline
...
Testing of standardized procedures and inspection throughout the process. \\ \hline
...
Communications test with POCC. \\ \hline
...
The following tables, Table 3 and Table 4, disclose the requirements specific to the pallet carriers (PC) and the science carriers (SC), respectively, as outlined in the TAMU-SPIRIT Quick Reference Guide [2]. \cite{tamuSpiritQRGv3_2025}
...
\begin{table}[!htbp]
    ...
    \setlength{\tabcolsep}{4pt}
    \renewcommand{\arraystretch}{1.15}
    \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}m{2.2cm}YYY@{}}
    \toprule
    \textbf{Requirement ID and Traceability} & \textbf{Requirement} & \textbf{Rationale} & \textbf{Verification Method} \\
    \midrule
    ...
    Pre-flight integration dimensional inspection. \\ \hline
    ...
    Ground functional power test. \\ \hline
...
\begin{table}[!t]
    ...
    Mitigates launch and integration risk through mass limitation. &
    Weighing of each SC prior to integration. \\ \hline
...
The requirements for this experiment are shown in Table~\ref{tab:tds_requirements} which were developed with the assistance of a research proposal document for the lunar dust sensor. \cite{kurwitz-lsep-2026}
...
\begin{table}[H]
    ...
    \setlength{\tabcolsep}{4pt}
    \renewcommand{\arraystretch}{1.15}
    \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}m{2.4cm}YYY@{}}
    \toprule
    \textbf{Requirement ID and Traceability} & \textbf{Requirement} & \textbf{Rationale} & \textbf{Verification Method} \\
    \midrule
    TDS-R1\\TDS-G1 &
    ...
    Control tests will be performed using dust on earth to ensure proper calibration. \\ \hline
    ...
    A number of tests on the impacts of parasitic thermal radiation will be performed, and proper orientation will be developed. \\ \hline
    ...
    Testing of the maximum required bandwidth of data will take place. \\ \hline
    ...
    The power needs of the sensor will be calculated and tested. \\ \hline
...
The requirements shown in Table~\ref{tab:mgvs_requirements} outline the requirements that have been formulated with the help of Dr. Kurwitz, and the specific aims he had selected for the timeline of the research project. \cite{kurwitz-lsep-2026}
...
\begin{table}[H]
    ...
    The bandwidth requirement of thermodynamic sensors shall be tested. \\ \hline
    ...
    Various refinement levels will be tested to calculate the 5\% deviation mesh. \\ \hline
    ...
    The power needs of the heat exchangers will be calculated and experimentally tested. \\ \hline
    ...
    Analysis on sample data will ensure that refinement methods for this experiment are available and physically appropriate. \\ \hline
...
The objective of the experiment is to design a space-compliant cryogenic system to preserve vitrified mammalian organs for at least six months before returning to earth for transplantation into recipient specimens. There are two primary goals for this flight experiment.
...
\begin{table}[H]
    ...
    The internal temperature of the flight experiment chamber(s) will be continuously logged through the mission. The temperature of each specimen will be collected before and after the mission. \\ \hline
    ...
    Finite Element Analysis (FEA) will be used on all prototyped chamber systems, to ensure they can withstand a 20G expected load (10G maximum force with Factor of Safety = 2). \\ \hline
    ...
    A triple-walled cooling system will individually surround each kidney. The subchambers will be dye tested during prototyping to ensure there is no transfer between cavities. \\ \hline
    ...
    The internal pressure of the flight experiment chamber(s) will be continuously logged through the mission. The chamber(s) will be dye tested during prototyping to ensure there is no change in volume. \\ \hline
    ...
    Mass, volume, and power data will be both simulated and verified before launch on an integrated test platform. \\ \hline
...
\begin{table}[H]
    ...
    Testing of the full system against a digitally simulated orbit \\ \hline
    ...
    Red-teaming / antagonistic testing of gimbal control authority \\ \hline
    ...
    Inspection of system's output which contains all parameters required for training \\ \hline
    ...
    Red-teaming / antagonistic testing of data store and/or transmission systems \\ \hline
    ...
    Red-teaming / antagonistic testing of critical fault recovery subsystems. \\ \hline
...
\begin{table}[H]
    ...
    Laboratory moisture analysis will confirm that spores are desiccated to 10\%, containers will be subjected to leak tests, and sterility assessment will be performed prior to sealing the samples. \\ \hline
    ...
    Install passive or active radiation dosimeters adjacent to the spore samples. \\ \hline
    ...
    Install temperature and radiation sensors that track and record experiment exposure data for the entirety of the flight duration. \\ \hline
    ...
    Structural analysis, vibration testing, and hardware mounting will be conducted and assessed prior to launching. \\ \hline
...
\begin{table}[H]
    ...
    Install passive or active radiation dosimeters adjacent to the freeze-dried food samples. \\ \hline
    ...
    Sample containers will be subjected to leak tests, and sterility assessment will be performed prior to sealing the samples. \\ \hline
    ...
    A ground operations test will be conducted to evaluate the removal procedures of the sample containers, and hardware configuration will be assessed for accessibility. \\ \hline
...
\begin{table}[H]
    ...
    Measure all nine samples using calipers to confirm the volume constraint and weigh all nine samples together to confirm a total mass of less than 9 grams. \\ \hline
    ...
    Confirm all nine samples are retrieved upon the completion of the mission. \\ \hline
    ...
    Implement a thermal sensor to ensure the temperature range the samples experience in Group 1 and Group 3 are within the range of 100 °C to +100 °C. \\ \hline
    ...
    Implement a thermal sensor to ensure the temperature range the samples experience in Group 2 is within the range of 0 °C to 30 °C. \\ \hline
    ...
    Implement temperature and radiation sensors to measure and record data over the duration of the mission. \\ \hline
...
\begin{table}[H]
    ...
    Analyze outputs from returned data to ensure they meet requirements. \\ \hline
    ...
    Measuring the maximum angular rates of the gimbal setup. \\ \hline

    EBST-R3\\EBST-G1 &
    The EBST gimbal shall allow 180° of rotation on 2 axes. &
    Allows for higher fidelity simulation. &
    Measuring the maximum rotation angles of the gimbal axes. \\ \hline
    ...
    Determine output file sizes via simulated operation. \\ \hline
...
\begin{table}[H]
    ...
    Inspect specimen configuration, geometry and material. \\ \hline
    ...
    Perform structural analysis and vibration testing. Inspect mounting hardware prior to flight. \\ \hline
    ...
    Confirm specimen retrieval through post-flight inspection. \\ \hline
    ...
    Verify mission timeline and integration to confirm exposure duration. \\ \hline
    ...
    Test environmental sensors and review recorded mission data. \\ \hline
...
\begin{table}[H]
    ...
    Chamber temperature logging and post-flight compliance review. \\ \hline
    ...
    Pre-flight inspection of chamber count and treatment allocation. \\ \hline
    ...
    Pre-flight pressure leak testing and return visual inspection. \\ \hline
    ...
    Full-sequence ground simulation, including recovery from power interruption. \\ \hline
...
3) Finalize degradation metric, calibration, and sampling cadence. \\ \hline
...
2) Archive requirements with a revive checklist. \\ \hline
...
5) Size EMI and power budgets. \\ \hline
...
4) Close data budget, evaluation method, and update cadence. \\ \hline
...
5) Verify mechanical retention and removal process. \\ \hline
...
5) Verify retention and retrieval procedure. \\ \hline
...
5) Complete EMI check for sensor integrity. \\ \hline
...
4) Run EMI, structural, and thermal checks after hardware freeze. \\ \hline
...
5) Verify retention and retrieval rehearsal. \\ \hline
