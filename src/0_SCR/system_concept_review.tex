...
\begin{titlepage}
    ...
    \vspace{0.2cm}
    {\large \textbf{System Concept Review (SCR)}\par}
...
\begin{table}[!htbp]
    ...
    \midrule
    Sophia Cuellar & [Sections] & [Sections] & [Count] & [Count] \\
    Aiden Kampwerth & [Sections] & [Sections] & [Count] & [Count] \\
    Noah Matus & [Sections] & [Sections] & [Count] & [Count] \\
    Riley McNew & [Sections] & [Sections] & [Count] & [Count] \\
    Steven Minniear & [Sections] & [Sections] & [Count] & [Count] \\
    Vin Manoj Nair & [Sections] & [Sections] & [Count] & [Count] \\
    Param Patel & [Sections] & [Sections] & [Count] & [Count] \\
    Matthew Thanjan & [Sections] & [Sections] & [Count] & [Count] \\
    \bottomrule
    \end{tabularx}
\end{table}
\clearpage
...
\begin{table}[!htbp]
    ...
    \textbf{SpaceX} &
      ...
      3 \\
    \midrule
    \multirow{3}{*}{\shortstack[c]{\textbf{Principal}\\\textbf{Investigator (PI)}}} &
    ...
    & The project aligns with the research specialty of the PI, and has substantial technical potential in the field. &
      2 \\
    \midrule
    \multirow{5}{*}{\shortstack[c]{\textbf{Texas A\&M}\\\textbf{Aerospace Department}}} &
    ...
    & The project design stays within the allotted budget by the aerospace department, and any additional funding from relevant research PIs. &
      2 \\
    \midrule
    \multirow{3}{*}{\textbf{Texas A\&M University}} &
...
\begin{table}[!htbp]
    ...
    \textbf{Reference} \\
    \midrule
    \multirow{17}{*}{\shortstack[c]{\textbf{Program}\\\textbf{Goals}}}
    ...
    \midrule
    \multirow{25}{*}{\shortstack[c]{\textbf{System}\\\textbf{Goals}}}
